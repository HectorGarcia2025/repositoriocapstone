...
# ==========================
modelo = SVC(
    kernel="rbf",          # kernel radial → capta relaciones no lineales
    C=10,                  # regularización media
    gamma=0.05,            # suaviza las fronteras
...
joblib.dump(modelo, "../modelo_textil_ml/models/modelo_curva_svm_class.joblib")
joblib.dump(scaler_X, "../modelo_textil_ml/models/scaler_X_svm_class.joblib")
...
joblib.dump(resultados, "../modelo_textil_ml/models/metricas_svm_class.joblib")

print("\n✅ Modelo SVM balanceado guardado correctamente.")
